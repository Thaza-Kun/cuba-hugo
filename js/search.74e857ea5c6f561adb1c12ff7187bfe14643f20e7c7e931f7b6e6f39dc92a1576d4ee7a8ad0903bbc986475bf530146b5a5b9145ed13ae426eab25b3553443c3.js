...
const idx = [
  ...
  },
  {
    ...
    "title": "Godek-Godek",
    "body": `[Cuba Hugo Ini adalah laman cubaan yang digunakan untuk membina laman mirip buku teks. Target pertama kita ialah agar boleh mendukung kandungan Catatan Mekanik Kuantum. Templat mendasar laman ini ialah templat compose. Sedang diubah suai sedikit demi sedikit. Templat hugo-cite juga digunakan untuk memudahkan penulisan bibliografi. Perkara yang sudah dilaksanakan: Sokongan MathJax (partial/math-jax.html) telah ditambah. Sokongan KaTeX disimpan dalam fail partial/math-katex.html sebagai sandaran. Extension physics telah ditambah dalam MathJax sebagai tetapan lalai supaya memudahkan penulisan pembezaan \(\dv{f}{x}\), trigonometri \(\sin[2](\theta)\), dan beberapa makro lain seperti bra dan ket \(\braket{\Psi}\). Blok untuk hukum, catatan, dan amaran telah ditambah. Perkara yang belum dilaksanakan: Blok untuk petua dan bukti belum ditambah. Nak bersihkan tema supaya hanya fail yang perlu sahaja digunakan.]`.toLowerCase(),
  },
  {
